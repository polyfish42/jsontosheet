...
var _user$project$Accio$spreadsheetUrl = function (res) {
	var _p2 = res;
	if (_p2.ctor === 'Ok') {
		return _p2._0;
	} else {
		return 'no spreadsheet';
	}
};
		...
		if (_p5.ctor === '::') {
			if ((_p5._1.ctor === '::') && (_p5._1._1.ctor === '[]')) {
				return {
					key: A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$String$dropLeft, 5, _p5._0),
						'\"'),
					value: _p5._1._0,
					selected: false,
					id: id,
				...
				return {
					key: A2(_elm_lang$core$String$dropLeft, 5, _p5._0),
					value: '',
					selected: false,
					id: id,
					indent: A2(
		...
		while (true) {
			...
			if (_p6.ctor === '[]') {
				...
				var _v34 = _p6._1,
					...
					_v36 = {
					ctor: '::',
					_0: A2(_user$project$Accio$newKeyValue, _p6._0, uid),
					_1: acc
				};
				response = _v34;
				uid = _v35;
...
var _user$project$Accio$requestCsv = function (token) {
	...
	if (_p7.ctor === 'Just') {
		return A2(
			...
			_user$project$Accio$putRequest(_p7._0));
	} else {
		...
		switch (_p8.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							keyValues: A2(
								_elm_lang$core$List$append,
								model.keyValues,
								_user$project$Accio$enterKeyValues(_p8._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Url':
			...
			case 'Fetch':
				if (_p8._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Accio$format(_p8._0._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
			...
			case 'Select':
				var updateSelected = function (t) {
					return _elm_lang$core$Native_Utils.eq(t.key, _p8._0) ? _elm_lang$core$Native_Utils.update(
						t,
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.spreadsheetUrl)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
