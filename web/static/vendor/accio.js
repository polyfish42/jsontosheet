					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							responses: A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_user$project$Accio$newResponse, _p4, model.uid)
									]))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var Elm = {};
Elm['Accio'] = Elm['Accio'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Accio'], 'Accio', typeof _user$project$Accio$main === 'undefined' ? null : _user$project$Accio$main);
