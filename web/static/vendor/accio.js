...
var _user$project$Accio$viewResponse = function (keyValue) {
	return A2(
		_elm_lang$html$Html$section,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Accio$viewLine(keyValue),
			_1: {ctor: '[]'}
		});
};
var _user$project$Accio$viewKeyedResponse = function (keyValue) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(keyValue.value),
		_1: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Accio$viewResponse, keyValue)
	};
};
...
var _user$project$Accio$newKeyValue = function (input) {
	return {
...
var _user$project$Accio$enterKeyValues = function (response) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Accio$newKeyValue,
...
var _user$project$Accio$KeyValue = F4(
	function (a, b, c, d) {
		return {key: a, value: b, selected: c, indent: d};
	});
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							keyValues: A2(
								_elm_lang$core$Basics_ops['++'],
								model.keyValues,
								_user$project$Accio$enterKeyValues(_p2._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Url':
			...
			default:
				if (_p2._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Accio$format(_p2._0._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
