...
var _user$project$Accio$viewLine = function (lineStr) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(lineTxt),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Accio$viewResponse = function (response) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Accio$parseJson(response.text),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Accio$newResponse = F2(
	function (str, id) {
		return {text: str, selected: false, id: id};
	});
...
var _user$project$Accio$Model = F6(
	function (a, b, c, d, e, f) {
		return {url: a, errorMessage: b, field: c, uid: d, selected: e, responses: f};
	});
...
var _user$project$Accio$Response = F3(
	function (a, b, c) {
		return {text: a, selected: b, id: c};
	});
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							responses: A2(
								...
								{
									ctor: '::',
									_0: A2(_user$project$Accio$newResponse, _p4, model.uid),
									_1: {ctor: '[]'}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							responses: A2(_elm_lang$core$List$map, updateSelected, model.responses)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Accio$viewResponses(model.responses),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
