...
var _user$project$Accio$encodeKeyValues = function (keyValues) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(keyValues.key),
		_1: _elm_lang$core$Json_Encode$string(keyValues.value)
	};
};
var _user$project$Accio$selectedToJson = function (model) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Accio$encodeKeyValues,
		A2(
			...
			case 'Fetch':
				if (_p7._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Accio$format(
							A2(_elm_lang$core$Debug$log, 'first response', _p7._0._0))
					};
				} else {
					return {
						ctor: '_Tuple2',
